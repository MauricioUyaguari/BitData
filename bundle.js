...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_select__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_selectAll__ = __webpack_require__(231);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touch__ = __webpack_require__(232);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_touches__ = __webpack_require__(233);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(22);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = dataTransform;




const datesRanges = (option) => {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = datesRanges;




const inputProperDate = (date) => {
  const format = __WEBPACK_IMPORTED_MODULE_0_d3__["timeFormat"]("%Y-%m-%d");
  const newDate = format(date);
  return newDate;
};


const renderNiceTimeDate = (dateTime) => {
...
const nytImesBitCoin = (date, range) => {
...
/* unused harmony export nytImesBitCoin */



const nyTimesDate = (date) => {
  date = new Date (date);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__functions__ = __webpack_require__(17);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_functions__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_news_functions_js__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lastMonth__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__currentData__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__currentNews__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bitcoin_historical_news__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__all_historical_news__ = __webpack_require__(470);
...
const renderBitData = (rangeDateInput) => {
  const ranges = __WEBPACK_IMPORTED_MODULE_1__util_functions__["b" /* datesRanges */](rangeDateInput),
  startDate = ranges[0],
  endDate = ranges[1],
  apiHost = "https://api.coindesk.com/v1/bpi/historical/close.json?start=",
  url = apiHost + startDate + "&end=" + endDate;
  __WEBPACK_IMPORTED_MODULE_0_d3__["json"](url, function(error, data) {
    if(error){
      console.log(error);
    }else {
      data = __WEBPACK_IMPORTED_MODULE_1__util_functions__["a" /* dataTransform */](data.bpi);
...
const prepare = (data) => {
  ...
  newlabel.append(`<div>
    ...
    <button class="close-button">Close Data Vis </button>
    </div>
    `);
    ...
    $(".historicalBitcoinNews").empty();
    $(".historicalBitcoinNews-title").empty();

    $(".allNewsVis-title").empty();
    $("#allNewsVis").empty();

   $(".historicalAllNews-title").empty();
   $(".historicalAllNews").empty();
...
const getData = () => __WEBPACK_IMPORTED_MODULE_0_d3__["json"]("https://api.coindesk.com/v1/bpi/historical/close.json", function(error, lastThirty) {
  if(error){
    console.log(error);
  }else {
    const lastThirtyData = __WEBPACK_IMPORTED_MODULE_1__util_functions__["a" /* dataTransform */](lastThirty.bpi);
...
const showData = (data) => {
  window.data = data;
    ...
    let svg = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]("#one-month");
    ...
    g.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(__WEBPACK_IMPORTED_MODULE_0_d3__["axisBottom"](x)
        .ticks(__WEBPACK_IMPORTED_MODULE_0_d3__["timeDay"].every(4))
        .tickFormat(function(d, i) {
        return __WEBPACK_IMPORTED_MODULE_0_d3__["timeFormat"]("%m/%d/%y")(d);
        }))
      .select(".domain")
      .remove();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_functions__ = __webpack_require__(17);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = renderCurrent;
...
const renderCurrentAllNews = (data) => {
  ...
  data.forEach(newsResponse => {
    ...
    newsli.append(`<div class="currentNews-info-div">
                    <p class="news-title"> <a href="${url}" > ${title} </a> </p>
...
/* harmony export (immutable) */ __webpack_exports__["a"] = displayDateInformation;
